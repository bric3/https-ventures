...
//            KeyStore ks;
//            try(InputStream inputStream = new BufferedInputStream(Files.newInputStream(Paths.get("/Users/brice/work/renault/shield-oauth-plugin/renault-internal-chain-truststore.jks")))) {
